# Requirements: Källkritik - Konspirationsteorier och AI
...
- **FORD-01**: Logiska felslut och argumentationsanalys som explicit verktyg
- **FORD-02**: Bad News-spelet som komplement till AI-labben
- **FORD-03**: Scaffolding-fade med explicita per-elev-triggar
- **FORD-04**: E/C/A-differentiering med explicit C-nivå genomgående
...
| AI-teknikfördjupning (hur modeller fungerar) | Fokus är att granska output, inte förstå tekniken |
| Debatt om yttrandefrihet/censur | Relevant men ett eget moment |
| Omfattande psykologifördjupning om konspirationstänkande | Kort intro räcker, risk att överbelasta momentet |
| Digitala verktygsdjupdykning (Deepware Scanner etc.) | Verktygen ändras för snabbt |
